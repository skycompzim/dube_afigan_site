<!-- Start UberGallery <?php echo GibsonDubePhotoGallery::VERSION; ?> - Copyright (c) <?php echo date('Y'); ?> Chris Kankiewicz (http://www.ChrisKankiewicz.com) -->
<div id="galleryWrapper">
    ...
    <div id="galleryFooter" class="clearfix">
        ...
        <div id="credit">Powered by, <a href="http://skycomp.co.zw">Skycomp Systems (Pvt) Ltd</a></div>
